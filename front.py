...
bus_capacity = st.sidebar.slider("Bus Capacity", min_value=0, max_value=300, value=100, step=1)
color_treshold = st.sidebar.slider("Color treshold", min_value=0.0, max_value=0.3, value=0.1, step=0.01)
